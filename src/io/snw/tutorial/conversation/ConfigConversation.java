...
public class ConfigConversation {
    ...
    public void editConfig(Player player) {
        this.factory = new ConversationFactory(ServerTutorial.getInstance())
                .withModality(true)
    ...
    private class AutoUpdater extends StringPrompt {
        ...
        public Prompt acceptInput(ConversationContext context, String input) {
            if(input.equalsIgnoreCase("true") || input.equalsIgnoreCase("false")) {
                ServerTutorial.getInstance().getConfig().set("auto-update", input);
                return new Done();
            } else if (input.equalsIgnoreCase("cancel")) {
                return new ConfigOption();
            }
    ...
    private class Metrics extends StringPrompt {
        ...
        public Prompt acceptInput(ConversationContext context, String input) {
            if(input.equalsIgnoreCase("true") || input.equalsIgnoreCase("false")) {
                ServerTutorial.getInstance().getConfig().set("metrics", input.toLowerCase());
                return new Done();
            } else if (input.equalsIgnoreCase("cancel")) {
                return new ConfigOption();
            }
    ...
    private class SignText extends StringPrompt {
        ...
        public Prompt acceptInput(ConversationContext context, String input) {
            if(!input.toLowerCase().equalsIgnoreCase("cancel") && input.length() <= 15) {
                ServerTutorial.getInstance().getConfig().set("sign", input);
                return new Done();
    ...
    private class FirstJoin extends StringPrompt {
        ...
        public Prompt acceptInput(ConversationContext context, String input) {
            if(input.equalsIgnoreCase("true") || input.equalsIgnoreCase("false")) {
                ServerTutorial.getInstance().getConfig().set("first_join", input.toLowerCase());
                return new Done();
            } else if(input.toLowerCase().equalsIgnoreCase("cancel")) {
                return new ConfigOption();
            }
        ...
        public Prompt acceptInput(ConversationContext context, String input) {
            if(!input.equalsIgnoreCase("cancel")) {
                if(Caching.getCaching().tutorial().containsKey(input)) {
                    ServerTutorial.getInstance().getConfig().set("first_join_tutorial", input);
                    return new Done();
                } else {
                    return new FirstJoinTutorial();
                }
    ...
    private class Rewards extends StringPrompt {
        ...
        public Prompt acceptInput(ConversationContext context, String input) {
            if(input.equalsIgnoreCase("true") || input.equalsIgnoreCase("false")) {
                ServerTutorial.getInstance().getConfig().set("rewards", input.toLowerCase());
                return new Done();
            } else if(input.toLowerCase().equalsIgnoreCase("cancel")) {
                return new ConfigOption();
            }
    ...
    private class ExpCountDown extends StringPrompt {
        ...
        public Prompt acceptInput(ConversationContext context, String input) {
            if(input.equalsIgnoreCase("true") || input.equalsIgnoreCase("false")) {
                ServerTutorial.getInstance().getConfig().set("exp_countdown", input.toLowerCase());
                return new Done();
            } else if(input.equalsIgnoreCase("cancel")) {
                return new ConfigOption();
            }
    ...
    private class ViewMoney extends StringPrompt {
        ...
        public Prompt acceptInput(ConversationContext context, String input) {
            if (input.toLowerCase().equalsIgnoreCase("true") || input.toLowerCase().equalsIgnoreCase("false")) {
                ServerTutorial.getInstance().getConfig().set("view_money", input.toLowerCase());
                return new Done();
            } else if(input.equalsIgnoreCase("cancel")) {
                return new ConfigOption();
            }
    ...
    private class ViewExp extends StringPrompt {
        ...
        public Prompt acceptInput(ConversationContext context, String input) {
            if(input.equalsIgnoreCase("true") || input.equalsIgnoreCase("false")) {
                ServerTutorial.getInstance().getConfig().set("view_exp", input.toLowerCase());
            } else if(input.equalsIgnoreCase("cancel")) {
                return new ConfigOption();
            }
            return new Done();
    ...
    private class TutorialMoney extends StringPrompt {
        ...
        public Prompt acceptInput(ConversationContext context, String input) {
            if(input.equalsIgnoreCase("true") || input.equalsIgnoreCase("false")) {
                ServerTutorial.getInstance().getConfig().set("tutorial_money", input.toLowerCase());
            } else if(input.equalsIgnoreCase("cancel")) {
                return new ConfigOption();
            }
            return new Done();
    ...
    private class TutorialExp extends StringPrompt {
        ...
        public Prompt acceptInput(ConversationContext context, String input) {
            if(input.equalsIgnoreCase("true") || input.equalsIgnoreCase("false")) {
                ServerTutorial.getInstance().getConfig().set("tutorial_exp", input.toLowerCase());
            } else if(input.equalsIgnoreCase("cancel")) {
                return new ConfigOption();
            }
            return new Done();
    ...
    private class PerTutorialMoney extends StringPrompt {
        ...
        public Prompt acceptInput(ConversationContext context, String input) {
            if(!Double.isNaN(Double.valueOf(input))) {
                ServerTutorial.getInstance().getConfig().set("per_tutorial_money", input);
            } else if (input.equalsIgnoreCase("cancel")) {
                return new ConfigOption();
            } else {
                return new PerTutorialMoney();
    ...
    private class PerTutorialExp extends StringPrompt {
        ...
        public Prompt acceptInput(ConversationContext context, String input) {
            if(!Float.isNaN(Float.valueOf(input))) {
                ServerTutorial.getInstance().getConfig().set("per_tutorial_exp", input);
            } else if(input.equalsIgnoreCase("cancel")) {
                return new ConfigOption();
            } else {
                return new PerTutorialExp();
    ...
    private class PerViewMoney extends StringPrompt {
        ...
        public Prompt acceptInput(ConversationContext context, String input) {
            if(!Double.isNaN(Double.valueOf(input))) {
                ServerTutorial.getInstance().getConfig().set("per_view_money", input);
            } else if(input.equalsIgnoreCase("cancel")) {
                return new ConfigOption();
            } else {
                return new PerViewMoney();
    ...
    private class PerViewExp extends StringPrompt {
        ...
        public Prompt acceptInput(ConversationContext context, String input) {
            if(!Float.isNaN(Float.valueOf(input))) {
                ServerTutorial.getInstance().getConfig().set("per_view_exp", input);
            } else if(input.equalsIgnoreCase("cancel")) {
                return new ConfigOption();
            } else {
                return new PerViewExp();

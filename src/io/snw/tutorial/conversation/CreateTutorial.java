...
public class CreateTutorial {
    ...
    public void writeNewTutorial(String name, String viewType, String endMessage, Object timeLength, String playerName) {
        ...
        CreateTutorialEvent event = new CreateTutorialEvent(ServerTutorial.getInstance().getServer().getPlayer(playerName), Getters.getGetters().getTutorial(name));
